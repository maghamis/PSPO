window.SCRUM_GUIDE = {
  "meta": {
    ...
    "copyright": "© 2020 Ken Schwaber and Jeff Sutherland",
    "license": "Creative Commons Attribution Share-Alike 4.0 International (CC BY-SA 4.0)",
    "licenseUrl": "https://creativecommons.org/licenses/by-sa/4.0/",
    "sourceNote": "Text extracted from the user-provided 2020 Scrum Guide PDF."
  },
  "sections": [
    {
      "id": "purpose-of-the-scrum-guide",
    ...
    {
      "id": "commitment-product-goal",
      "title": "Commitment: Product Goal",
      "paragraphs": [
    ...
    {
      "id": "commitment-sprint-goal",
      "title": "Commitment: Sprint Goal",
      "paragraphs": [
    ...
    {
      "id": "commitment-definition-of-done",
    ...
    {
      "id": "scrum-guide-history",
      "title": "Scrum Guide History",
      "paragraphs": [
