...
- Fully built-in local PSPO question bank with original practice questions plus your uploaded sample-exam questions and explanations
...
- Question-bank dashboard stats: total questions, core/expanded/sample count, seen count, unseen count, answered count, and accuracy
...
- Compiled the uploaded `Qs List.docx` sample exam file into the local question bank.
- Deduplicated the uploaded set by question wording: 90 listed question entries became 43 unique sample-exam questions.
- Added answers and explanations for each uploaded sample question.
- Dashboard now separates core, expanded, and uploaded sample-exam question counts.
- Quiz and Exam continue to shuffle the full local bank before selecting questions.
- Offline cache updated to v11.
